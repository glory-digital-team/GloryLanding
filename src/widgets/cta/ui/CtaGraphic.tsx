...
//   Group 11 — стрелки часов (в макете — статичный «росчерк» в позе 12:20)
//
...
// Чтобы стрелки крутились, росчерк разобран на два отрезка с круглыми торцами
// той же толщины (18.02) — в позе 12:20 они совпадают с исходной геометрией.
...
export function CtaGraphic({ className }: { className?: string }) {
  return (
    <div className={className} aria-hidden="true">
      ...
      {/* Group 11 — стрелки часов: вращаются вокруг оси на стеклянной грани */}
